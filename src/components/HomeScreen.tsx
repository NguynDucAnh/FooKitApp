...
import { mapHomepageDishToRecipe, mapSuggestedDishToRecipe } from '../mappers/recipeMapper';
...
export function HomeScreen({ onRecipeClick, onUpgradePremium }: HomeScreenProps) {
  ...
  async function loadSuggestions() {
    ...
    try {
      ...
      setSuggestions({
        breakfast: result.breakfast.map((dish, index) => mapHomepageDishToRecipe(dish, 'breakfast', index)),
        lunch: result.lunch.map((dish, index) => mapHomepageDishToRecipe(dish, 'lunch', index)),
        dinner: result.dinner.map((dish, index) => mapHomepageDishToRecipe(dish, 'dinner', index)),
      });
    } catch {
